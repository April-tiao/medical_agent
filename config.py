...
GRAPH_TEMPLATE = {
    'desc': { #疾病的描述
        'slots': ['disease'],#disease一个实体
        'question': '什么叫%disease%? / %disease%是一种什么病？',
        'cypher': "MATCH (n:Disease) WHERE n.name='%disease%' RETURN n.desc AS RES",#MATCH某一个疾病节点，起个名字AS RES
        'answer': '【%disease%】的定义：%RES%',#RES是CQL语句查到的内容
    },
    'cause': {
        'slots': ['disease'],
